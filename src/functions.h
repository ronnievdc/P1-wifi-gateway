...
void zapFiles() {
  ...
  deleteFile("/WeeksE1.log");
  deleteFile("/WeeksE2.log");
  deleteFile("/WeeksR1.log");
  deleteFile("/WeeksR2.log");
  deleteFile("/WeeksTE.log");
  deleteFile("/WeeksTR.log");
  deleteFile("/WeeksG.log");
